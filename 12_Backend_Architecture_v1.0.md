...
| Depends On | 10_Database_Architecture_v1.0, 11_API_Integration_Architecture_v1.0 |
...
The backend owns business orchestration.
...
The frontend never directly accesses external providers or service-role credentials.
...
| Reminder Service | Reminder evaluation and scheduling |
...
| --- | --- | --- |
| v1.0 | Current | Backend architecture frozen after IR-004 and IR-009. |
