...
| Depends On | 00_Project_Governance_v1.2, 01_Product_Strategy_v1.3, 02_Experience_Strategy_v1.2, 03_Information_Architecture_v1.2 |
...
| v1.3 | Current | Added payment method field to Add Subscription and rail-specific cancellation guidance to Subscription Details, per DEC-032. Corrected title/Document Control version to match filename (was misstated as v1.2) and updated dependency reference to 01_Product_Strategy_v1.3. |
