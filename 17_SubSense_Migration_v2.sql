...
-- Generated from 10_Database_Architecture_v1.7.md.
...
-- Path A CRUD tables per 11_API_Integration_Architecture_v1.4
...
-- "searchable catalog" (01_Product_Strategy_v1.10) would be empty on any fresh environment.
...
-- would fail with NOTIF_001 template missing (11_API_Integration_Architecture_v1.4) on a fresh database.
