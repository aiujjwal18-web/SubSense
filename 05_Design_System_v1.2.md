...
| Depends On | 00_Project_Governance_v1.2, 01_Product_Strategy_v1.3, 02_Experience_Strategy_v1.2, 03_Information_Architecture_v1.2, 04_Experience_Blueprint_v1.3 |

## Purpose

This document defines reusable visual, interaction, feedback, accessibility, and responsive standards for SubSense.

It does not define screen-specific layouts. Those belong to `04_Experience_Blueprint_v1.3.md`.
...
| v1.2 | Current | Implementation Freeze alignment and expanded reusable standards. Updated dependency references to 01_Product_Strategy_v1.3 and 04_Experience_Blueprint_v1.3. |
